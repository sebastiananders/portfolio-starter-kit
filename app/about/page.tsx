...
export const metadata = {
  title: 'About',
  description: 'Product manager and builder, based in Berlin. 15 years in digital products, taking things from opportunity to release and prototyping in code.',
}
  ...
  return (
    <section className="max-w-xl mx-4 mt-6 lg:mx-auto px-2 md:px-0">
      ...
      <p className="mb-8 text-neutral-800 dark:text-neutral-200">
        Product manager who still builds. I take products from opportunity to release — discovery, roadmap, requirements, alignment with executives and engineering — and prototype in code so specifications are testable and estimates are grounded. B2B and B2C, currently focused on AI product surfaces.
      </p>
